...
| PUR-007 | PO receiving consumes server-owned outstanding quantities | PURCHASING; SUPPLIER_RECEIVING | `applyPurchaseOrderReceipt`; trusted `recordPurchaseOrderReceipt` command | Partial, final and over-receipt tests | Trusted Phase 4 receiving integration required | Direct received-total mutation denied | Required | Partial |
