export type InventoryMovementType = 'OPENING_BALANCE' | 'SUPPLIER_RECEIPT' | 'SUPPLIER_RECEIPT_REVERSAL' | 'TRANSFER_DISPATCH' | 'TRANSFER_RECEIPT' | 'TRANSFER_REVERSAL' | 'SALE' | 'SALE_REVERSAL' | 'CUSTOMER_RETURN' | 'SUPPLIER_RETURN' | 'STOCKTAKE_ADJUSTMENT' | 'DAMAGE_WRITE_OFF' | 'MANUAL_ADJUSTMENT';
